class ReviewModel {
  ...
  final String reviewerRole; // 'CREATOR', 'BUSINESS'
  ...
  factory ReviewModel.fromJson(Map<String, dynamic> json) {
    return ReviewModel(
      ...
      reviewerName: json['reviewerName'] as String? ??
          ...
          (json['reviewer'] as Map<String, dynamic>?)?['companyName'] as String? ??
          'Reviewer',
      reviewerAvatar: json['reviewerAvatar'] as String? ??
          (json['reviewer'] as Map<String, dynamic>?)?['avatarUrl'] as String? ??
          (json['reviewer'] as Map<String, dynamic>?)?['logoUrl'] as String?,
      reviewerRole: json['reviewerRole'] as String? ??
          (json['reviewer'] as Map<String, dynamic>?)?['role'] as String? ??
          'BUSINESS',
