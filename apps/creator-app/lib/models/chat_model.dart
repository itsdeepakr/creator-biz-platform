class ChatMessage {
  ...
  final String senderRole; // 'CREATOR', 'BUSINESS', 'ADMIN'
  final String content;
  final String? mediaUrl;
  final String messageType; // 'TEXT', 'IMAGE', 'OFFER', 'SYSTEM'
  final bool isRead;
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) {
    return ChatMessage(
      ...
      senderRole: json['senderRole'] as String? ??
          (json['sender'] as Map<String, dynamic>?)?['role'] as String? ??
          'CREATOR',
  ...
  factory Conversation.fromJson(Map<String, dynamic> json) {
    return Conversation(
      ...
      otherUserId: json['otherUserId'] as String? ??
          (json['recipient'] as Map<String, dynamic>?)?['id'] as String? ??
          '',
      otherUserName: json['otherUserName'] as String? ??
          (json['recipient'] as Map<String, dynamic>?)?['name'] as String? ??
          (json['recipient'] as Map<String, dynamic>?)?['fullName'] as String? ??
          (json['business'] as Map<String, dynamic>?)?['companyName'] as String? ??
          'Partner',
      otherUserAvatar: json['otherUserAvatar'] as String? ??
          (json['recipient'] as Map<String, dynamic>?)?['avatarUrl'] as String? ??
          (json['business'] as Map<String, dynamic>?)?['logoUrl'] as String?,
      otherUserRole: json['otherUserRole'] as String? ??
          (json['recipient'] as Map<String, dynamic>?)?['role'] as String? ??
          'BUSINESS',
      campaignId: json['campaignId'] as String? ??
          (json['campaign'] as Map<String, dynamic>?)?['id'] as String?,
      campaignTitle: json['campaignTitle'] as String? ??
          (json['campaign'] as Map<String, dynamic>?)?['title'] as String?,
      lastMessage: json['lastMessage'] as String? ??
          (json['latestMessage'] as Map<String, dynamic>?)?['content'] as String? ??
          'No messages yet',
      lastMessageAt: json['lastMessageAt'] != null
          ...
          : (json['latestMessage'] != null && json['latestMessage']['createdAt'] != null
              ? DateTime.tryParse(json['latestMessage']['createdAt'] as String) ?? DateTime.now()
              : DateTime.now()),
